 ...
 * the slot O2 left). It renders from QUESTIONS[0] rather than a copy of it, so
 * the question on the home page can never drift from the question in the tool,
 * and each option links into the tool with that answer already recorded — the
 * tool reads it from the URL and opens on question 2.
 *
...
export function HeroToolSlot() {
  ...
  return (
    <div className="tool-slot" data-slot="bolagsform-q1" id="hero-tool-slot">
      <p className="tool-slot__label">
        Fråga 1 av {QUESTIONS.length}
      </p>
