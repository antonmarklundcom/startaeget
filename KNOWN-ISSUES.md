...
- ~~**Annonspolicyn har en kvarvarande motsägelse.**~~ — löst i commit `e33e6b3` ("Fix false Annonslänk labels on non-monetized partner comparisons"), efter att den här punkten skrevs. `content/pages/annonspolicy.mdx` säger nu tydligt att en leverantör märks "Annonslänk" även innan ett ersättningsprogram är aktivt, och namnger exakt de sex leverantörer (de fyra storbankerna, Länsförsäkringar Företag, WooCommerce) som i stället får "Vi tjänar inget på den här länken" — verifierat 2026-09-16 mot `content/affiliates.ts`: precis de sex har `disclosure: PLAIN`, alla andra 21 har `disclosure: ANNONS`.
